	...
	return (
		<div className='w-full mx-auto max-w-5xl flex items-center justify-center py-20 flex-wrap'>
			<div className='w-full md:w-1/2 p-4'>
				<h1 className='text-7xl font-thin'>Get Your Vaccine Today!</h1>
				<p className='mt-8'>
			...
			<div className='flex w-full md:w-1/2 p-4 gap-8 scale-75 md:scale-100 items-center justify-center'>
